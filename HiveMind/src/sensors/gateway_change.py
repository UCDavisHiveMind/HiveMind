...
sensor_name = 'gateway_change'

update_on_fail = False
enabled = True

class gateway_change(SensorSpec):
#- default enable state on initialization
	def __init__(self, name, enabled=True):
		super(gateway_change, self).__init__(name, enabled)
		print ">>> INITING gateway_change"
	...
	def compare(self, observed, reference):
        ...
        #- note: not all sensors will have a response
			...
			self.message = "gateway change compared to baseline"
